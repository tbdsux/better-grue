    ...
    <div className="mt-4">
      <div>
        <input
          ...
          } py-3 px-6 w-full text-xl sm:text-2xl border-2 text-gray-500 rounded-full outline-none focus:border-green-400 focus:text-green-500`}
      ...
      <div className="my-2">
        {shrinkDone ? (
          ...
          <button
            ...
            } hover:bg-green-500 ml-3 text-white rounded-lg outline-none focus:outline-none px-4`}
          >
            {buttonText}
          </button>
        )}
